...
TRACK_STREAM_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(ATTR_SEND_LIVE_IMAGE, default=True): cv.boolean,
        vol.Optional(ATTR_SEND_UPDATE_IMAGE, default=True): cv.boolean,
        vol.Optional(ATTR_SEND_OFFLINE_IMAGE, default=True): cv.boolean,
